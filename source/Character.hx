	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				animation.addByPrefix('singUPmiss', 'Dad Sing Note UP Miss', 24, false);
				animation.addByPrefix('singRIGHTmiss', 'Dad Sing Note RIGHT Miss', 24, false);
				animation.addByPrefix('singDOWNmiss', 'Dad Sing Note DOWN Miss', 24, false);
				animation.addByPrefix('singLEFTmiss', 'Dad Sing Note LEFT Miss', 24, false);
			...
			case 'spooky':
				...
				animation.addByPrefix('singUPmiss', 'spooky UP NOTE miss', 24, false);
				animation.addByPrefix('singDOWNmiss', 'spooky DOWN note miss', 24, false);
				animation.addByPrefix('singLEFTmiss', 'note sing left miss', 24, false);
				animation.addByPrefix('singRIGHTmiss', 'spooky sing right miss', 24, false);
			...
			case 'monster':
				...
				animation.addByPrefix('singUPmiss', 'Monster Up Miss', 24, false);
				animation.addByPrefix('singDOWNmiss', 'Monster Down Miss', 24, false);
				animation.addByPrefix('singLEFTmiss', 'Monster Left Miss', 24, false);
				animation.addByPrefix('singRIGHTmiss', 'Monster Right Miss', 24, false);
				...
				addOffset("singUPmiss", -20, 50);
				addOffset("singRIGHTmiss", -51);
				addOffset("singLEFTmiss", -30);
				addOffset("singDOWNmiss", -30, -40);
				playAnim('idle');
			...
			case 'pico':
				...
				addOffset("singLEFT", 80, -20);
				addOffset("singDOWN", 110, -80);
				addOffset("singUPmiss", 30, 67);
				addOffset("singRIGHTmiss", -35, 50);
				addOffset("singLEFTmiss", 75, 30);
				addOffset("singDOWNmiss", 110, -30);
			...
			case 'bf-dead':
				frames = Paths.getSparrowAtlas('Game_Over_Assets');
				animation.addByPrefix('singUP', "Player Death", 24, false);
				animation.addByPrefix('firstDeath', "Player Death", 24, false);
